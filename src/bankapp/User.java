...
public class User {
	...
	public void createAccount(String accountType, String accountName) {
		...
		BankAccount acc = accountType.equalsIgnoreCase("checking") ? new CheckingAccount(accountName)
				: new SavingsAccount(accountName);
	...
	public void renameAccount(String oldName, String newName) {
		...
		if (accounts.containsKey(newName))
			throw new IllegalArgumentException("New account name already exists.");
	...
	public void printSummary() {
		...
		for (BankAccount acc : accounts.values()) {
			System.out.println("- " + acc.getName() + " (" + acc.getAccountType() + "), Balance: $" + acc.getBalance()
